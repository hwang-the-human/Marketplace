...
const (
	ProfileService_GetProfileByID_FullMethodName = "/profiles.ProfileService/GetProfileByID"
	ProfileService_CreateProfile_FullMethodName  = "/profiles.ProfileService/CreateProfile"
)
...
func (c *profileServiceClient) GetProfileByID(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse, error) {
...
func (UnimplementedProfileServiceServer) GetProfileByID(context.Context, *GetProfileRequest) (*GetProfileResponse, error) {
...
func _ProfileService_GetProfileByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).GetProfileByID(ctx, req.(*GetProfileRequest))
	}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "shared/protobuf/profile.proto",
}
